...
if section == "Main":
    ...
    team_country_mapping = {
        ...
        'USA': 'United States',  # Ensure USA is mapped correctly
        'Ireland': 'Ireland',
        'Kenya': 'Kenya',
        'Oman': 'Oman',
...
# Create a choropleth map for geospatial distribution of matches
    ...
    # Display the bar plot and the choropleth side by side
    col1, col2 = st.columns(2)
    with col1:
...
if section == "Main":
    ...
    # Extract numeric match margin from the 'Margin' column
    ...
    # Display scatter plot and data frame side by side
    col1, col2 = st.columns(2)
    with col1:
